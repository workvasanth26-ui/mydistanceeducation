...
export const COUNTRIES: Country[] = [
  mk("study-in-uk", "United Kingdom", "🇬🇧", "World-class universities with 1-year master's options.",
  ...
  mk("study-in-usa", "United States of America", "🇺🇸", "Largest higher education ecosystem with world-leading research.",
  ...
  mk("study-in-canada", "Canada", "🇨🇦", "Affordable quality education with strong post-study work pathways.",
  ...
  mk("study-in-australia", "Australia", "🇦🇺", "Innovative universities and lifestyle-friendly campuses.",
  ...
  mk("study-in-new-zealand", "New Zealand", "🇳🇿", "Quality education in a safe, scenic environment.",
  ...
  mk("study-in-germany", "Germany", "🇩🇪", "Tuition-free public universities with engineering excellence.",
  ...
  mk("study-in-france", "France", "🇫🇷", "World leader in business, fashion and culinary arts.",
  ...
  mk("study-in-ireland", "Ireland", "🇮🇪", "Tech hub of Europe with strong post-study work options.",
  ...
  mk("study-in-italy", "Italy", "🇮🇹", "Affordable European education with rich heritage.",
  ...
  mk("study-in-netherlands", "Netherlands", "🇳🇱", "English-taught programs with strong international outlook.",
  ...
  mk("study-in-singapore", "Singapore", "🇸🇬", "Asia's premier education and business hub.",
  ...
  mk("study-in-malaysia", "Malaysia", "🇲🇾", "Affordable global education with branch campuses.",
  ...
  mk("study-in-dubai-uae", "Dubai / UAE", "🇦🇪", "Global business hub with international branch campuses.",
